...
//Original RPSTrainer example from site http://modelai.gettysburg.edu/2013/cfr/
//Average strategy tends towards a ~0, ~1, ~0 probability, to "exploit" that 
//the opponent has a bias towards action 0 (40% chance vs. 30% chance for the rest)
